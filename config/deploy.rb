...
set :scm, :git
set :scm_passphrase, ""
set :application, "brightpush-aim-sync"
set :deploy_to, "/var/www/brightpush-aim-sync"
set :repository,  "git@bright.unfuddle.com:bright/brightpush-aim-sync.git"
set :user, "ubuntu"
...
# end
 ...
 namespace :deploy do
  ...
  task :start_workers, :roles => :app do
    run "cd #{release_path}/java/aim-token-synchronization && mkdir bin && /usr/bin/ant"
